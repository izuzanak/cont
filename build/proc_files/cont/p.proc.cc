...
{/*{{{*/
   ...
   process_s::pa_reduce_null,
   process_s::pa_reduce_exp_exclamation,
   process_s::pa_reduce_null,
   process_s::pa_reduce_exp_id,
   process_s::pa_reduce_null,
...
{/*{{{*/
   ...
   unsigned condition = enable_stack.pop();
...
{/*{{{*/
   ...
   unsigned second = enable_stack.pop();
   unsigned first = enable_stack.pop();
   enable_stack.push(first && second);
}/*}}}*/
...
{/*{{{*/
   ...
   unsigned value = enable_stack.pop();
   enable_stack.push(!value);
}/*}}}*/

void process_s::pa_reduce_exp_id(process_s &proc)
{/*{{{*/
   processor_s &processor = *proc.processor_ptr;
   ...
   enable_stack.push(processor.define_tree.get_idx(define) != c_idx_not_exist);
}/*}}}*/
