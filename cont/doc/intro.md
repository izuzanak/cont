...
In this chapter individual generators are described in detail.
  ...
  **Generator**  |**Description**                                          |**Reference**
  ---------------|---------------------------------------------------------|-----------------------------------------------------------------
  `struct`       |Structure of named members.                              |[struct](#contStruct)
  `array`        |Dynamic array of objects.                                |[array](#contArray)
  `queue`        |Dynamic queue of objects.                                |[queue](#contQueue)
  `list`         |Linked list of elements.                                 |[list](#contList)
  `rb_tree`      |Balanced binary tree.                                    |[rb_tree](#contRbTree)
...
List of function generated by `struct` follows:
  ...
  **Function**        |**Category**   |**Complexity** |**Description**
  --------------------|---------------|---------------|---------------------------------
  `struct_init`       |               |O(1)           |[struct_init](#contInit)
  `struct_clear`      |               |O(1)           |[struct_clear](#contClear)
  `struct_set`        |`set`          |O(1)           |[struct_set](#structSet)
  `struct_flush_all`  |               |O(1)           |[struct_flush_all](#contFlushAll)
  `struct_swap`       |               |O(1)           |[struct_swap](#contSwap)
  `struct_copy`       |               |O(1)           |[struct_copy](#contCopy)
  `struct_compare`    |               |O(1)           |[struct_compare](#contCompare)
...
List of functions generated by `array` follows:
  ...
  **Function**         |**Category**          |**Complexity** |**Description**
  ---------------------|----------------------|---------------|-------------------------------------
  `array_init`         |                      |O(1)           |[array_init](#contInit)
  `array_init_size`    |                      |O(1), O(n)     |[array_init_size](#contInitSize)
  `array_clear`        |                      |O(1), O(n)     |[array_clear](#contClear)
  `array_set`          |`set`                 |O(n)           |[array_set](#arraySet)
  `array_flush`        |                      |O(1), O(n)     |[array_flush](#contFlush)
  `array_flush_all`    |                      |O(1), O(n)     |[array_flush_all](#contFlushAll)
  `array_swap`         |                      |O(1)           |[array_swap](#contSwap)
  `array_at`           |`retrieve`            |O(1)           |[array_at](#contAt)
  `array_reserve`      |                      |O(1), resize   |[array_reserve](#arrayReserve)
  `array_push`         |`insert`              |O(1), resize   |[array_push](#arrayPush)
  `array_push_blank`   |`insert`              |O(1), resize   |[array_push_blank](#arrayPushBlank)
  `array_push_blanks`  |`insert`              |O(1), resize   |[array_push_blanks](#arrayPushBlanks)
  `array_push_clear`   |`insert`              |O(1), resize   |[array_push_clear](#arrayPushClear)
  `array_pop`          |`retrieve`, `remove`  |O(1)           |[array_pop](#arrayPop)
  `array_last`         |`retrieve`            |O(1)           |[array_last](#arrayLast)
  `array_copy_resize`  |                      |O(1), O(n)     |[array_copy_resize](#contCopyResize)
  `array_fill`         |`set`                 |O(n)           |[array_fill](#arrayFill)
  `array_get_idx`      |`find`                |O(n)           |[array_get_idx](#contGetIdx)
  `array_copy`         |                      |O(n)           |[array_copy](#contCopy)
  `array_compare`      |                      |O(n)           |[array_compare](#contCompare)
  `array_init_buffer`  |                      |O(1), O(n)     |[array_init_buffer](#contInitBuffer)
  `array_set_buffer`   |                      |O(1), O(n)     |[array_set_buffer](#contSetBuffer)
...
List of functions generated by `queue` follows:
  ...
  **Function**          |**Category**          |**Complexity** |**Description**
  ----------------------|----------------------|---------------|-------------------------------------------------------------------------------------
  `queue_init`          |                      |O(1)           |[queue_init](#contInit)
  `queue_init_size`     |                      |O(1), O(n)     |[queue_init_size](#contInitSize)
  `queue_clear`         |                      |O(1), O(n)     |[queue_clear](#contClear)
  `queue_flush`         |                      |O(1), O(n)     |[queue_flush](#contFlush)
  `queue_flush_all`     |                      |O(1), O(n)     |[queue_flush_all](#contFlushAll)
  `queue_swap`          |                      |O(1)           |[queue_swap](#contSwap)
  `queue_at`            |`retrieve`            |O(1)           |[queue_at](#contAt)
  `queue_insert`        |`insert`              |O(1), resize   |[queue_insert](#queueInsert)
  `queue_insert_blank`  |`insert`              |O(1), resize   |[queue_insert_blank](#queueInsertBlank)
  `queue_next`          |`retrieve`, `remove`  |O(1)           |[queue_next](#queueNext)
  `queue_first`         |`retrieve`            |O(1)           |[queue_first](#queueFirst)
  `queue_last`          |`retrieve`            |O(1)           |[queue_last](#queueLast)
  `queue_copy_resize`   |                      |O(1), O(n)     |[queue_copy_resize](#contCopyResize)
  `queue_copy`          |                      |O(n)           |[queue_copy](#contCopy)
  `queue_compare`       |                      |O(n)           |[queue_compare](#contCompare)
  `queue_init_buffer`   |                      |O(1), O(n)     |[queue_init_buffer](#contInitBuffer)
  `queue_set_buffer`    |                      |O(1), O(n)     |[queue_set_buffer](#contSetBuffer)
...
List of functions generated by `list` follows:
  ...
  **Function**                |**Category**   |**Complexity** |**Description**
  ----------------------------|---------------|---------------|----------------------------------------------------------------------------------------------
  `list_init`                 |               |O(1)           |[list_init](#contInit)
  `list_init_size`            |               |O(1), O(n)     |[list_init_size](#contInitSize)
  `list_clear`                |               |O(1), O(n)     |[list_clear](#contClear)
  `list_flush`                |               |O(1), O(n)     |[list_flush](#contFlush)
  `list_flush_all`            |               |O(1), O(n)     |[list_flush_all](#contFlushAll)
  `list_swap`                 |               |O(1)           |[list_swap](#contSwap)
  `list_at`                   |`retrieve`     |O(1)           |[list_at](#contAt)
  `list_prepend`              |`insert`       |O(1), resize   |[list_prepend](#listPrepend)
  `list_append`               |`insert`       |O(1), resize   |[list_append](#listAppend)
  `list_insert_before`        |`insert`       |O(1), resize   |[list_insert_before](#listInsertBefore)
  `list_insert_after`         |`insert`       |O(1), resize   |[list_insert_after](#listInsertAfter)
  `list_prepend_blank`        |`insert`       |O(1), resize   |[list_prepend_blank](#listPrependBlank)
  `list_append_blank`         |`insert`       |O(1), resize   |[list_append_blank](#listAppendBlank)
  `list_insert_blank_before`  |`insert`       |O(1), resize   |[list_insert_blank_before](#listInsertBlankBefore)
  `list_insert_blank_after`   |`insert`       |O(1), resize   |[list_insert_blank_after](#listInsertBlankAfter)
  `list_remove`               |`remove`       |O(1)           |[list_remove](#listRemove)
  `list_next_idx`             |`iterate`      |O(1)           |[list_next_idx](#listNextIdx)
  `list_prev_idx`             |`iterate`      |O(1)           |[list_prev_idx](#listPrevIdx)
  `list_copy_resize`          |               |O(1), O(n)     |[list_copy_resize](#contCopyResize)
  `list_get_idx`              |`find`         |O(n)           |[list_get_idx](#contGetIdx)
  `list_copy`                 |               |O(n)           |[list_copy](#contCopy)
  `list_compare`              |               |O(n)           |[list_compare](#contCompare)
  `list_init_buffer`          |               |O(1), O(n)     |[list_init_buffer](#contInitBuffer)
  `list_set_buffer`           |               |O(1), O(n)     |[list_set_buffer](#contSetBuffer)
...
List of functions generated by `rb_tree` follows:
  ...
  **Function**                    |**Category**      |**Complexity**     |**Description**
  --------------------------------|------------------|-------------------|-----------------------------------------------------------------------------------------------------------
  `tree_init`                     |                  |O(1)               |[tree_init](#contInit)
  `tree_clear`                    |                  |O(1), O(n)         |[tree_clear](#contClear)
  `tree_flush`                    |                  |O(1), O(n)         |[tree_flush](#contFlush)
  `tree_flush_all`                |                  |O(1), O(n)         |[tree_flush_all](#contFlushAll)
  `tree_swap`                     |                  |O(1)               |[tree_swap](#contSwap)
  `tree_at`                       |`retrieve`        |O(1)               |[tree_at](#contAt)
  `tree_insert`                   |`insert`          |O(log(n)), resize  |[tree_insert](#rbTreeInsert)
  `tree_unique_insert`            |`find`, `insert`  |O(log(n)), resize  |[tree_unique_insert](#rbTreeUniqueInsert)
  `tree_swap_insert`              |`insert`          |O(log(n)), resize  |[tree_swap_insert](#rbTreeSwapInsert)
  `tree_unique_swap_insert`       |`find`, `insert`  |O(log(n)), resize  |[tree_unique_swap_insert](#rbTreeUniqueSwapInsert)
  `tree_remove`                   |`remove`          |O(1)               |[tree_remove](#rbTreeRemove)
  `tree_copy_resize`              |                  |O(1), O(n)         |[tree_copy_resize](#contCopyResize)
  `tree_get_min_value_idx`        |`iterate`         |O(log(n))          |[tree_get_min_value_idx](#rbTreeGetMinValueIdx)
  `tree_get_max_value_idx`        |`iterate`         |O(log(n))          |[tree_get_max_value_idx](#rbTreeGetMaxValueIdx)
  `tree_get_next_idx`             |`iterate`         |O(log(n))          |[tree_get_next_idx](#rbTreeGetNextIdx)
  `tree_get_prev_idx`             |`iterate`         |O(log(n))          |[tree_get_prev_idx](#rbTreeGetPrevIdx)
  `tree_get_descent_stack_size`   |`stack iterate`   |O(1)               |[tree_get_descent_stack_size](#rbTreeGetDescentStackSize)
  `tree_get_stack_min_value_idx`  |`stack iterate`   |O(log(n))          |[tree_get_stack_min_value_idx](#rbTreeGetStackMinValueIdx)
  `tree_get_stack_next_idx`       |`stack iterate`   |O(log(n))          |[tree_get_stack_next_idx](#rbTreeGetStackNextIdx)
  `tree_get_idx`                  |`find`            |O(log(n))          |[tree_get_idx](#contGetIdx)
  `tree_get_idx_left`             |`find`            |O(log(n))          |[tree_get_idx_left](#rbTreeGetIdxLeft)
  `tree_get_gre_idx`              |`find`            |O(log(n))          |[tree_get_gre_idx](#rbTreeGetGreIdx)
  `tree_get_lee_idx`              |`find`            |O(log(n))          |[tree_get_lee_idx](#rbTreeGetLeeIdx)
  `tree_get_idxs`                 |`find`            |O(log(n))          |[tree_get_idxs](#rbTreeGetIdxs)
  `tree_copy`                     |                  |O(n)               |[tree_copy](#contCopy)
  `tree_compare`                  |                  |O(n\*log(n))       |[tree_compare](#contCompare)
  `tree_init_buffer`              |                  |O(1), O(n)         |[tree_init_buffer](#contInitBuffer)
  `tree_set_buffer`               |                  |O(1), O(n)         |[tree_set_buffer](#contSetBuffer)
