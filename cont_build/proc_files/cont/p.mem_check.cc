...
{/*{{{*/
   ...
   mc_block_rb_tree_s_node *n_data;

   if (a_size == 0) {
      n_data = NULL;
   }
   else {
      n_data = (mc_block_rb_tree_s_node *)cmalloc(a_size*sizeof(mc_block_rb_tree_s_node));
   }

   if (used != 0) {
      memcpy(n_data,data,used*sizeof(mc_block_rb_tree_s_node));
   }
